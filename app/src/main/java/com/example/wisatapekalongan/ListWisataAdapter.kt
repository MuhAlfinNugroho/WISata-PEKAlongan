...
class ListWisataAdapter(private val listAnime: ArrayList<Wisata>)  : RecyclerView.Adapter<ListWisataAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val view: View =
            LayoutInflater.from(parent.context).inflate(R.layout.item_row_wisata, parent, false)
